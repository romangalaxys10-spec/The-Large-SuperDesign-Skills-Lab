---
name: sd-clay
description: Clay — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/clay
---

# Clay

> Clay design.md. Light-mode-default editorial system built on a warm off-white canvas, sculpted 3D-toy illustration, one lime-chartreuse accent, and rationed ...
...
:root {
  ...
  --accent: #9fe870;
  --accent-soft: #eff7e7;   /* tint backgrounds */
  --good: #34d399;
  --hot: #87c55f;         /* urgency only */
  /* radii */
