---
name: sd-rationed-aurora-light
description: Rationed Aurora Light Design System — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/rationed-aurora-light
---

# Rationed Aurora Light Design System

> Stripe design.md. White-dominant editorial system with a violet brand core, a rationed multi-hue aurora reserved for hero and section-break moments, and a lo...
...
Load this design system when the product is a **saas / product site** and the brand voice is *light-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  ...
  --accent: #8b5cf6;
  --accent-soft: #ece7f7;   /* tint backgrounds */
  --good: #34d399;
