---
name: sd-global-enterprise-intelligence-design-system
description: Global Enterprise Intelligence Design System — Enterprise B2B. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/global-enterprise-intelligence-design-system
---

# Global Enterprise Intelligence Design System

> Global Enterprise Intelligence Design System design.md. 面向全球企业信息查询、商业信用分析、风险识别和企业关系研究的数据产品设计系统。视觉语言专业、可信、国际化、清晰且克制。
