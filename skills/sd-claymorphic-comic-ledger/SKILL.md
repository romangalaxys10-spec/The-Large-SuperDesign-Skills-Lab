---
name: sd-claymorphic-comic-ledger
description: Claymorphic Comic Ledger — Fintech / dashboard. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/claymorphic-comic-ledger
---

# Claymorphic Comic Ledger

> Claymorphic Comic Ledger design.md. A neobrutalist, claymorphic system built on a chunky rounded display face, hard black outlines with offset drop-shadows, ...
