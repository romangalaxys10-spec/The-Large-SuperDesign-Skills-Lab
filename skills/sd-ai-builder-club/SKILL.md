---
name: sd-ai-builder-club
description: Ai Builder Club Design System — AI product / platform. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/ai-builder-club
---

# Ai Builder Club Design System

> AI Builder Club design.md. Near-black flat-panel system on true-black page voids, Inter-only type at heavy display weight, a single rationed blue accent, and...
...
Load this design system when the product is a **ai product / platform** and the brand voice is *dark-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
