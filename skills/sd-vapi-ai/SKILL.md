---
name: sd-vapi-ai
description: Vapi Ai — AI product / platform. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/vapi-ai
---

# Vapi Ai

> Vapi Ai design.md. Editorial-minimal light system with a photographic full-bleed hero, glass navbar and control chips, near-black content bands, and one rati...
