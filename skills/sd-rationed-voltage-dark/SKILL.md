---
name: sd-rationed-voltage-dark
description: Rationed Voltage Dark Design System — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/rationed-voltage-dark
---

# Rationed Voltage Dark Design System

> Clickhouse design.md. Near-black engineering-grade system with hairline-outlined glass panels, oversized display type, and one caustic yellow accent reserved...
...
:root {
  ...
  --accent: #f9d71c;
  --accent-soft: #1d1903;   /* tint backgrounds */
  --good: #34d399;
  --hot: #d3b617;         /* urgency only */
  /* radii */
