---
name: sd-faceted-plum-institutional
description: Faceted Plum Institutional — Enterprise B2B. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/faceted-plum-institutional
---

# Faceted Plum Institutional

> Faceted Plum Institutional design.md. Light-dominant editorial-institutional system built on triangular full-bleed section breaks, deep-plum content panels, ...
...
Load this design system when the product is a **enterprise b2b** and the brand voice is *light-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  ...
  --accent: #b06ad2;
  --accent-soft: #f1e8f3;   /* tint backgrounds */
  --good: #34d399;
  --hot: #955ab2;         /* urgency only */
  /* radii */
...
| Icon | Feature | Copy |
|---|---|---|
| 🏢 | **Enterprise ready** | SSO, SLAs, audit trails |
| 📊 | **Reporting** | Board-ready exports |
| 🔐 | **Compliance** | SOC 2 / ISO aligned |
