---
name: dentacare-clinical-mint
description: DentaCare Clinical Mint — Healthcare / dental clinic. Airy clinical mint-sky with soft blob shapes. Use when building interfaces that need this exact visual identity.
origin: vercel
source: https://dentacare-hazel.vercel.app
---

# DentaCare Clinical Mint

> Outfit-based clinical system on sky-and-mint radial washes, large organic radii, gradient pill buttons and floating info chips. Friendly healthcare that still reads professional.

- **Category:** Healthcare / dental clinic
- **Mood:** Airy clinical mint-sky with soft blob shapes
- **Source:** Live Vercel demo (built by Rommark.dev)
**Live reference:** [https://dentacare-hazel.vercel.app](https://dentacare-hazel.vercel.app)


## When to use this skill

Load this design system when the product is a **healthcare / dental clinic** and the brand voice is *airy clinical mint-sky with soft blob shapes*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  /* surfaces */
  --bg: #f7fbfe;          /* page canvas */
  --surface: #ffffff;  /* cards, nav */
  /* ink */
  --ink: #123047;         /* headings */
  --ink-2: #47657b;      /* body */
  --muted: #7c9ab0;     /* captions */
  --line: #ddebf5;       /* hairlines & borders */
  /* accent — RATIONED: CTAs, active states, data highlights only */
  --accent: #1e8fd6;
  --accent-soft: #dff0fa;   /* tint backgrounds */
  --good: #10b981;
...
| Icon | Feature | Copy |
|---|---|---|
| 🦷 | **Guided implants** | Printed surgical guides, flapless |
| 😁 | **Same-day crowns** | Scan, mill, place in one visit |
| 📱 | **0% installments** | Approved in ten minutes |
| 🧒 | **Kids corner** | Zero-fear first visits |
