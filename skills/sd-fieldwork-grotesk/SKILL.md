---
name: sd-fieldwork-grotesk
description: Fieldwork Grotesk — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/fieldwork-grotesk
---

# Fieldwork Grotesk

> Fieldwork Grotesk design.md. Cream-and-black editorial system with condensed Sora display type, a single rationed orange fill, angled corner-brackets, and sk...
