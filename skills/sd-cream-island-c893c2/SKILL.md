---
name: sd-cream-island-c893c2
description: Cream Island — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/cream-island-c893c2
---

# Cream Island

> Cream Island design.md. A cream-and-charcoal light system built around one saturated violet media surface, with a rationed coral highlight, oversized display...
