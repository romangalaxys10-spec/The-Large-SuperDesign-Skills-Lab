---
name: sd-wdi
description: Wdi Design System — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/wdi
---

# Wdi Design System

> WDI design.md. A light, editorial-warm advocacy system on cream and white surfaces, carried by a coral/crimson headline voice, a rationed emerald accent for ...
...
:root {
  ...
  --accent: #34d399;
  --accent-soft: #e2f5ec;   /* tint backgrounds */
  --good: #34d399;
  --hot: #2cb382;         /* urgency only */
  /* radii */
