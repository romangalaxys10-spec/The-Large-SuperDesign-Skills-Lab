---
name: sd-viktor
description: Viktor — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/viktor
---

# Viktor

> Viktor design.md. Light-mode-default system on warm off-white linen, with an oversized bold-rounded display face, a single indigo-to-peach radial gradient ra...
