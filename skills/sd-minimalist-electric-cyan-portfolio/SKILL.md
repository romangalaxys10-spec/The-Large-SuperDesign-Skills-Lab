---
name: sd-minimalist-electric-cyan-portfolio
description: Minimalist Electric Cyan Portfolio — Portfolio / editorial. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/minimalist-electric-cyan-portfolio
---

# Minimalist Electric Cyan Portfolio

> Minimalist Electric Cyan Portfolio design.md. Updated the color scheme to Electric Cyan (#00D9FF), refined the design to be more minimalist by reducing shado...
...
Load this design system when the product is a **portfolio / editorial** and the brand voice is *light-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  ...
  --accent: #22d3ee;
  --accent-soft: #e0f5f6;   /* tint backgrounds */
  --good: #34d399;
  --hot: #1cb3ca;         /* urgency only */
  /* radii */
