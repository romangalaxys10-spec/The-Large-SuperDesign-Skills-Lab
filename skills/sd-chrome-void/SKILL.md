---
name: sd-chrome-void
description: Chrome Void — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/chrome-void
---

# Chrome Void

> Chrome Void design.md. Near-black 3D-grid dark mode with a chrome wireframe hero, rationed violet-to-ember radial washes, and condensed extended display type...
