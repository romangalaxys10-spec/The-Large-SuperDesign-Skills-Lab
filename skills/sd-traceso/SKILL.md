---
name: sd-traceso
description: Traceso Design System — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/traceso
---

# Traceso Design System

> trace.so design.md. A light, paper-toned operational aesthetic pairing a bureaucratic ivory field with sharp-cornered mono labels, one dark near-black UI pan...
...
:root {
  ...
  --accent: #ef4444;
  --accent-soft: #1c0808;   /* tint backgrounds */
  --good: #34d399;
