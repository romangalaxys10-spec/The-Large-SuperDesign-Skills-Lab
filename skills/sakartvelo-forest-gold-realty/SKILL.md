---
name: sakartvelo-forest-gold-realty
description: Sakartvelo Forest &amp; Gold Realty — Real estate / investment advisory. Deep forest authority with gold-leaf accents. Use when building interfaces that need this exact visual identity.
origin: vercel
source: https://sakartvelo-homes.vercel.app
---

# Sakartvelo Forest & Gold Realty

> Marcellus serif over deep forest green with gold rationing for value signals. Filter chips, property cards and yield math for investment-grade realty.

- **Category:** Real estate / investment advisory
- **Mood:** Deep forest authority with gold-leaf accents
- **Source:** Live Vercel demo (built by Rommark.dev)
**Live reference:** [https://sakartvelo-homes.vercel.app](https://sakartvelo-homes.vercel.app)


## When to use this skill

Load this design system when the product is a **real estate / investment advisory** and the brand voice is *deep forest authority with gold-leaf accents*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  /* surfaces */
  --bg: #f4efe6;          /* page canvas */
  --surface: #ffffff;  /* cards, nav */
  /* ink */
  --ink: #1c2a24;         /* headings */
  --ink-2: #536058;      /* body */
  --muted: #8a968d;     /* captions */
  --line: #e4dcc9;       /* hairlines & borders */
  /* accent — RATIONED: CTAs, active states, data highlights only */
  --accent: #c8a45e;
  --accent-soft: #164233;   /* tint backgrounds */
  --good: #2f7d54;
  --hot: #c96a44;         /* urgency only */
  /* radii */
...
| Role | Font | Usage |
|---|---|---|
| Display / headings | `Marcellus', sans-serif` | Hero + section titles, tight tracking (-0.02em to -0.04em) |
| Body / UI | `Archivo', sans-serif` | Paragraphs, buttons, forms |
...
| Icon | Feature | Copy |
|---|---|---|
| ◆ | **Verified titles** | Full lien & chain checks per file |
| 📈 | **Yield underwriting** | Rental comps & exit scenarios |
| 🌍 | **1–3 day closing** | Foreign buyers, bilingual sets |
| 🗝️ | **Managed handover** | Property management after close |
