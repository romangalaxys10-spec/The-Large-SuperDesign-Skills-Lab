---
name: sd-apple
description: Apple — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
...
> Apple design.md. Light-mode-default retail system built on flat off-white panels, edge-to-edge product renders, and a single rationed blue lifted only for li...
...
:root {
  ...
  --accent: #3b82f6;
  --accent-soft: #e3ebf7;   /* tint backgrounds */
  --good: #34d399;
