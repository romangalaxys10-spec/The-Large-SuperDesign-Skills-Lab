---
name: sd-neon-db
description: Neon Db — Database / backend platform. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/neon-db
---

# Neon Db

> Neon DB design.md. Black-dominant developer-tool system with a bar-chart data-viz hero, rationed mint accent, sharp-cornered utilitarian components, and a ra...
...
:root {
  ...
  --accent: #ef4444;
  --accent-soft: #f8e4e2;   /* tint backgrounds */
  --good: #34d399;
  --hot: #cb3939;         /* urgency only */
  /* radii */
