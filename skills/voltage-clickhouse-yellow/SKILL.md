---
name: voltage-clickhouse-yellow
description: Voltage Clickhouse Yellow — Data platforms / OLAP databases. Engineering near-black with caustic yellow reserved for data. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/rationed-voltage-dark
---

# Voltage Clickhouse Yellow

> Enhanced from superdesign.dev&#x27;s Rationed Voltage (ClickHouse) study: engineering-grade near-black with hairline-outlined glass panels, oversized display type and one caustic yellow accent reserved strictly for data moments.

- **Category:** Data platforms / OLAP databases
- **Mood:** Engineering near-black with caustic yellow reserved for data
- **Source:** superdesign.dev design-systems study (enhanced)

## When to use this skill

Load this design system when the product is a **data platforms / olap databases** and the brand voice is *engineering near-black with caustic yellow reserved for data*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  /* surfaces */
  --bg: #0d0d0c;          /* page canvas */
  --surface: #161613;  /* cards, nav */
  /* ink */
  --ink: #f5f4ef;         /* headings */
  --ink-2: #c2c0b9;      /* body */
  --muted: #8f8d83;     /* captions */
  --line: #2a2a25;       /* hairlines & borders */
  /* accent — RATIONED: CTAs, active states, data highlights only */
  --accent: #f9d71c;
  --accent-soft: #23231a;   /* tint backgrounds */
  --good: #84cc16;
  --hot: #f97316;         /* urgency only */
  /* radii */
...
| Role | Font | Usage |
|---|---|---|
| Display / headings | `Archivo Expanded', sans-serif` | Hero + section titles, tight tracking (-0.02em to -0.04em) |
...
| Icon | Feature | Copy |
|---|---|---|
| ⚡ | **Sub-second scans** | Trillion-row aggregations |
| 🗜️ | **Columnar compression** | 10x smaller than rows |
| 🔀 | **Replication** | Synchronous by default |
| 🧪 | **SQL complete** | Joins, windows, dictionaries |
