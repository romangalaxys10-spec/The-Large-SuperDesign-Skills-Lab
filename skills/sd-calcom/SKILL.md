---
name: sd-calcom
description: Calcom Design System — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/calcom
---

# Calcom Design System

> Cal.com design.md. A light-mode, framed-canvas system on flat #F4F4F4 with a black-ink hairline border grid, a single near-black solid CTA, and a functional ...
