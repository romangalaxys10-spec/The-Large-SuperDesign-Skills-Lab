---
name: sd-warm-frame-portfolio-light
description: Warm Frame Portfolio Light — Portfolio / editorial. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
...
> Warm-frame portfolio light design.md. White-dominant editorial system built around a chestnut-framed device mockup, hand-scrawled labels, and a single black-...
