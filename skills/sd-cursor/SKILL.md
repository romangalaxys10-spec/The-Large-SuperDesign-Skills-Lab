---
name: sd-cursor
description: Cursor — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/cursor
---

# Cursor

> Cursor design.md. Off-white editorial system built to look like a documentation-grade IDE: near-black pill controls, EB Garamond serif body copy over CursorG...
