---
name: sd-atelier-reveal-or-pomodoro
description: Atelier Reveal Pomodoro — Portfolio / editorial. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/atelier-reveal-or-pomodoro
---

# Atelier Reveal Pomodoro

> Atelier Reveal | Pomodoro design.md. A full-screen, physics-based art reveal Pomodoro timer. A vintage painting spreads organically from the center as the ti...
