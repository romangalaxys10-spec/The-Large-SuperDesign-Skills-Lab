---
name: sd-lenisdev
description: Lenisdev Design System — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/lenisdev
---

# Lenisdev Design System

> Lenis.dev design.md. A near-black, star-field editorial system carrying one enormous cracked blackletter wordmark and a rationed coral-pink accent, set in de...
...
:root {
  ...
  --accent: #ff7a59;
  --accent-soft: #1e0e0a;   /* tint backgrounds */
  --good: #34d399;
  --hot: #d8674b;         /* urgency only */
  /* radii */
