---
name: sd-void-teal-ledger-glass
description: Void Teal Ledger Glass — Fintech / dashboard. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/void-teal-ledger-glass
---

# Void Teal Ledger Glass

> Void-teal ledger glass design.md. Near-black financial console with a near-imperceptible teal cast, small-scale display type, and rationed indigo/violet/emer...
...
Load this design system when the product is a **fintech / dashboard** and the brand voice is *dark-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  ...
  --accent: #5e6ad2;
  --accent-soft: #0b0c19;   /* tint backgrounds */
  --good: #34d399;
...
| Role | Font | Usage |
|---|---|---|
| Display / headings | `Archivo', sans-serif` | Hero + section titles, tight tracking (-0.02em to -0.04em) |
