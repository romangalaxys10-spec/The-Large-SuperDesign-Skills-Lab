---
name: sd-stack-ai
description: Stack Ai — AI product / platform. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/stack-ai
---

# Stack Ai

> Stack Ai design.md. Bright, near-white light-mode-default system with dot-grid technical texture, blue-link ink accents rationed to interactive text, and one...
