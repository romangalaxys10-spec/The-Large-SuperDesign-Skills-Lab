---
name: sd-terminal-cyan-ledger
description: Terminal Cyan Ledger — Fintech / dashboard. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/terminal-cyan-ledger
---

# Terminal Cyan Ledger

> Terminal Cyan Ledger design.md. Near-black operator-console aesthetic with a single rationed cyan signal color, slash-marked technical labels, and dense moni...
...
:root {
  ...
  --accent: #22d3ee;
  --accent-soft: #04191c;   /* tint backgrounds */
  --good: #34d399;
