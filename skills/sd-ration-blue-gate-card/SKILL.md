---
name: sd-ration-blue-gate-card
description: Ration Blue Gate Card — Fintech / dashboard. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/ration-blue-gate-card
---

# Ration Blue Gate Card

> Ration-blue gate card design.md. A single centered white authentication card floating on a soft aurora-tinted light field, with one saturated blue action and...
...
Load this design system when the product is a **fintech / dashboard** and the brand voice is *light-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
