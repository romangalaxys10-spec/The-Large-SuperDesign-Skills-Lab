---
name: sd-planetscale
description: Planetscale — Database / backend platform. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/planetscale
---

# Planetscale

> Planetscale design.md. A monospace, plain-text-editor aesthetic on a near-white ground: zero-radius rules, hairline borders, an orange accent rationed to a s...
...
:root {
  ...
  --accent: #fb923c;
  --accent-soft: #faede1;   /* tint backgrounds */
  --good: #34d399;
  --hot: #d57c33;         /* urgency only */
  /* radii */
