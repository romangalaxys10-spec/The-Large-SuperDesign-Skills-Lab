---
name: sd-confetti-minimal
description: Confetti Minimal — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/confetti-minimal
---

# Confetti Minimal

> Confetti minimal design.md. A light, near-white editorial base punctured by one saturated rainbow-gradient hero panel and a scatter of matching gradient tile...
