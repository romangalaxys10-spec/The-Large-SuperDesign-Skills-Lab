---
name: sd-wise
description: Wise — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
...
> Wise design.md. Light-mode-dominant system on a lime-saturated hero, built from an ultra-black condensed display face, hairline-glass utility buttons, and a ...
