---
name: sd-linear
description: Linear — SaaS / product site. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
...
> Linear design.md. Near-black, product-screenshot-led dark system with a single indigo interactive accent, tight negative-tracked Inter display type, and glas...
