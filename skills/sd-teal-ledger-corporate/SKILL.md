---
name: sd-teal-ledger-corporate
description: Teal Ledger Corporate — Enterprise B2B. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/teal-ledger-corporate
---

# Teal Ledger Corporate

> Teal Ledger Corporate design.md. Light-mode corporate SaaS system built on a near-white/pale-gray canvas with a rationed teal-to-cyan gradient identity, a fu...
