---
name: sd-the-modern-scholar
description: Modern Scholar — Portfolio / editorial. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/the-modern-scholar
---

# Modern Scholar

> The Modern Scholar design.md: a reusable design system with color, typography, spacing and radius tokens, ready to use as AI prompt context.
