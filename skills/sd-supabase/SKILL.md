---
name: sd-supabase
description: Supabase — Database / backend platform. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/supabase
---

# Supabase

> Supabase design.md. Light-mode-default engineering system on a near-white field, with a single mint-green accent rationed to CTAs and diagram glyphs, sharp-c...
...
Load this design system when the product is a **database / backend platform** and the brand voice is *light-mode system — enhanced from superdesign.dev study*. Apply the tokens verbatim before writing any component CSS.
...
:root {
  ...
  --accent: #22c55e;
  --accent-soft: #e0f3e5;   /* tint backgrounds */
  --good: #34d399;
  --hot: #1ca74f;         /* urgency only */
  /* radii */
...
| Role | Font | Usage |
|---|---|---|
| Display / headings | `Circular Std-like', sans-serif` | Hero + section titles, tight tracking (-0.02em to -0.04em) |
...
| Icon | Feature | Copy |
|---|---|---|
| 🗄️ | **Postgres native** | Full SQL, real extensions |
| ⚡ | **Autoscaling** | Scale to zero and back |
| 🌍 | **Multi-region** | Read replicas everywhere |
| 🔐 | **Branching** | DB branches like git |
