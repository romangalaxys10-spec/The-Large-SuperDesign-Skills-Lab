---
name: sd-railway
description: Railway — AI product / platform. Dark-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/railway
---

# Railway

> Railway design.md. Near-black editorial-dark system carried by a hand-painted twilight illustration, IBM Plex Serif display type, and a single violet accent ...
