---
name: sd-frequency-based-extraction
description: Frequency Based Extraction — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
source: https://superdesign.dev/design-systems/frequency-based-extraction
---

# Frequency Based Extraction

> Frequency-Based Extraction design.md. Design tokens extracted from frequency analysis without LLM interpretation.
