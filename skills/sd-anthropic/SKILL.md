---
name: sd-anthropic
description: Anthropic — SaaS / product site. Light-mode system — enhanced from superdesign.dev study. Use when building interfaces that need this exact visual identity.
origin: superdesign
...
> Anthropic design.md. A cream-paper, ink-black editorial system pairing a bold grotesque display with a serif for long-form voice, rationed with a single near...
...
| Role | Font | Usage |
|---|---|---|
| Display / headings | ` Grotesk', sans-serif` | Hero + section titles, tight tracking (-0.02em to -0.04em) |
